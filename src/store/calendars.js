...
export defineStore('davRestrictions', {
	state: () => {
		return {
			calendars: [],
			trashBin: undefined,
	...
	getters: {
		 ...
		 * @return {Array}
		 */
		sortedCalendarsSubscriptions(state, store) {
		 ...
		 */
		sortedCalendarFilteredByComponents: (state) => (vevent, vjournal, vtodo) => {
	...
	actions: {
		 ...
		 * @return {Promise}
		 */
		async toggleCalendarEnabled({ calendar }) {
